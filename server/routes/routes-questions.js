...
const { createQuestion, deleteQuestion, 
    ...
    getQuestions, returnQuestions,
     ...
     updateQuestionAndAnswers, getQuestionByIdEJS } = require
    ("../controllers/questions-controller.js");
const { returnTopics, getTopicByQuestion } = require("../controllers/topics-controller.js");
...
authRole(2), async (req, res) => {
    ...
    let themes = await returnThemes();
    let topics = await returnTopics();
    res.render('../views/edit-question.ejs', {question_id: questionId, questionContent,
        correctAnswer, incorrectAnswer1, incorrectAnswer2, themes, topics})
});
